...
const CreateForm = Form.create()(props => {
  ...
  return (
    ...
    >
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="地点具体描述">
        {form.getFieldDecorator('placeDesc', {
...
export default class TableList extends PureComponent {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="地点列表" content="包括小区地点、巴士途径地点以及路线终点">
        <Card bordered={false}>
